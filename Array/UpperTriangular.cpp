...
void  UpperTriangular :: set(int i,int j, int value){
        int index=j*(j+1)/2+i;
        arr[index]=value;
...
int main(){
    ...
    switch(choice){
        ...
        if(i>=j && i>=0 && j>=0){
            ...
            cout<<"Please Enter both i and j index as (j>=i)  and i>=0 and j>=0 for UpperTriangularmatrix property"<<endl;
